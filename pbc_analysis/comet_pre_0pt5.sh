...
#SBATCH --time=120:00
#SBATCH --array=9,21                       # Run tasks 1 through 22
...
../new_knockoffgwas_pipeline/run_pre_knockoff_gwas.sh $SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_ID $DATA/Nicola pbc 0.1 results 0.5 3
