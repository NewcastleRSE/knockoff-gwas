...
#SBATCH --output=slurm_part_only_%a_FDR20.out
...
../new_knockoffgwas_pipeline/run_knockoff_gwas_part_only.sh $SLURM_ARRAY_TASK_ID $DATA/Nicola pbc 0.1 results_d25_w3_FDR10
