...
#SBATCH --time=120:00
#SBATCH --array=1,4,6,11,15,17,19,20                       # Run tasks 1 through 22
...
../new_knockoffgwas_pipeline/run_pre_knockoff_gwas.sh $SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_ID $DATA/Nicola pbc 0.1 results 5 3
