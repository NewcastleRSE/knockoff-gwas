...
../new_knockoffgwas_pipeline/run_lmm.sh $SLURM_ARRAY_TASK_ID $DATA/Nicola pbc results $DATA"/tables/LDSCORE.1000G_EUR.GRCh38.tab.gz" $DATA"/tables/genetic_map_hg19_withX.txt.gz"
