...
2. The false discovery rate can be set to different values to calculate the final knockofGWAS results. While this is easy to set, it may require some thought.

3. Genetic map files must be supplied for the analysis which must be found.

4. The updated Shiny app makes it easy to view the results but interpretation may not be straightforward.
