...
The easiest way to run the app is to open the `app.R` file in RStudio :cite:`rstudio2025` :cite:`test` :cite:`test2` and click the green button, `Run App`, in the top right of the console.
